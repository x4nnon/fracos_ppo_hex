...
# below is for copy past for single instance
python3 $(pwd)/cleanrl/cleanrl/ppo.py --seed 1 --env-id LunarLander-v2 --current_depth=1 --wandb_project_name LL_seed_comparisons --total_timesteps=600000 --num_steps=512 --gen_strength=0.2

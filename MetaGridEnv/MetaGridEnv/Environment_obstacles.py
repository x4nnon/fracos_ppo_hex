...
class Environment():
    ...
    def seed(self, random_seed):
        if self.initial_random_seed:
            random.seed(random_seed)
            self.initial_random_seed = False
    ...
    def reset(self, goal_choice=[], start_same=True, total_random=False, train=True):
        ...
        if start_same and (goal_choice == []):
            ...
            if train:
                ...
                r_seed = random.randint(1001,2000)
